...
const navigation = [
  ...
  { name: "Add Course", href: "/instructor/add-course", icon: PlusCircle },
...
export function InstructorDashboardLayout() {
  ...
  const initials = user?.name.split(" ").map((part) => part[0]).join("").slice(0, 2) || "IN";
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-72 p-0">
              ...
              <SheetDescription className="sr-only">
                Access your instructor dashboard, courses, and analytics
              </SheetDescription>
              <Sidebar />
            </SheetContent>
          </Sheet>
